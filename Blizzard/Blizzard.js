...
blizzardApp.service("raceText", raceText)
...
function raceText()
{
    ...
    function getRaceText(raceName) 
    {
        
    }
    return {getRaceText: getRaceText};
}

blizzardApp.controller("blizzController", blizzController)
...
function blizzController($scope)
{
    ...
    {
        $scope.currentRace = raceText.getRaceText(raceName);
    }
}